...
public class RepairItemCriterion extends SimpleCriterionTrigger<RepairItemCriterion.Conditions> {
    ...
    public record Conditions(Optional<ContextAwarePredicate> playerPredicate) implements SimpleCriterionTrigger.SimpleInstance {
        public static Codec<RepairItemCriterion.Conditions> CODEC = ContextAwarePredicate.CODEC.optionalFieldOf("player")
