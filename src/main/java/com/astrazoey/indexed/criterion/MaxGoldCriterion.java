...
public class MaxGoldCriterion extends SimpleCriterionTrigger<MaxGoldCriterion.Conditions> {
    ...
    public record Conditions(Optional<ContextAwarePredicate> playerPredicate) implements SimpleCriterionTrigger.SimpleInstance {
        public static Codec<MaxGoldCriterion.Conditions> CODEC = ContextAwarePredicate.CODEC.optionalFieldOf("player")
