...
/**
 * ASM on Fabric? Definitely not, asie would never allow such a thing.
 */
public final class TransformerMixinPlugin implements IMixinConfigPlugin {
     ...
     */
    private record HackerVoice(
            Object delegate,
            Field mixinTransformerField
    ) {
    ...
    record ProxyMixinTransformer(
            IMixinTransformer delegate,
