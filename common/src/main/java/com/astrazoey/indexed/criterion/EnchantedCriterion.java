...
public class EnchantedCriterion extends SimpleCriterionTrigger<EnchantedCriterion.Conditions> {
    ...
    public record Conditions(Optional<ContextAwarePredicate> playerPredicate) implements SimpleCriterionTrigger.SimpleInstance {
        public static Codec<EnchantedCriterion.Conditions> CODEC = ContextAwarePredicate.CODEC.optionalFieldOf("player")
